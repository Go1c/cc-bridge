...
const allowSystemRoleModels = ref('claude-opus-5,claude-sonnet-5,claude-opus-4-8');
...
const interceptAssistantPrefillModels = ref('claude-fable-5,claude-opus-5,claude-sonnet-5,claude-opus-4-8,claude-opus-4-7');
...
async function loadSettings() {
  try {
    ...
    allowSystemRoleModels.value = data.allow_system_role_models ?? 'claude-opus-5,claude-sonnet-5,claude-opus-4-8';
    ...
    interceptAssistantPrefillModels.value = data.intercept_assistant_prefill_models ?? 'claude-fable-5,claude-opus-5,claude-sonnet-5,claude-opus-4-8,claude-opus-4-7';
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-4">
          ...
          <div class="space-y-2">
            ...
            <Input
              ...
              placeholder="claude-fable-5,claude-opus-5,claude-sonnet-5,claude-opus-4-8,claude-opus-4-7"
      ...
      <div class="p-6 space-y-4">
        ...
        <div class="space-y-2">
          ...
          <Input
            ...
            placeholder="claude-opus-5,claude-sonnet-5,claude-opus-4-8"
            class="border-[#e8e2d9] focus:ring-[#c4704f] font-mono text-sm"
          ...
          <div class="flex flex-wrap gap-1.5">
            ...
            <button
              type="button"
              @click="allowSystemRoleModels = 'claude-opus-5,claude-sonnet-5,claude-opus-4-8'"
            ...
            >Claude 5 + Opus 4.8</button>
            <button
              type="button"
              @click="allowSystemRoleModels = 'claude-opus-5,claude-sonnet-5'"
              class="px-2 py-0.5 text-xs rounded border border-[#e8e2d9] bg-[#f9f6f1] text-[#8c8475] hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
            >仅 Claude 5</button>
            <button
              type="button"
